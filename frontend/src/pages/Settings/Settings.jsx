    ...
    <div>
      ...
      <div className="settings-grid">
        ...
        <div className="card" style={{padding:24}}>
          <div style={{fontFamily:"var(--font-body)",fontSize:16,fontWeight:700,marginBottom:18}}>My Profile</div>
          <div style={{display:"flex",alignItems:"center",gap:16,marginBottom:20}}>
            <div style={{width:56,height:56,borderRadius:"50%",background:"linear-gradient(135deg,var(--accent),var(--accent2))",
              ...
              fontFamily:"var(--font-body)",fontSize:24,fontWeight:800,color:"#08080a"}}>
              {user?.full_name?.[0]||user?.username?.[0]||"A"}
            </div>
            <div>
              <div style={{fontWeight:700,fontSize:16}}>{user?.full_name||user?.username}</div>
              <div style={{fontSize:12,color:"var(--text1)"}}>{user?.email}</div>
        ...
        <div className="card" style={{ padding: 24, gridColumn: "1/-1" }}>
          <div style={{ fontFamily: "var(--font-body)", fontSize: 16, fontWeight: 700, marginBottom: 18 }}>
            Gym Settings
          </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 14, marginBottom: 18 }}>
              {GYM_FIELDS.map(({ key, label, type, hint }) => (
                <div className="form-group" key={key}>
                  ...
                  />
                  {hint && <div style={{ fontSize: 11, color: "var(--text1)", marginTop: 4 }}>{hint}</div>}
                </div>
              ))}
            </div>
        ...
        <div className="card" style={{ padding: 24, gridColumn: "1/-1" }}>
          <div style={{ fontFamily: "var(--font-body)", fontSize: 16, fontWeight: 700, marginBottom: 4 }}>
            WhatsApp Notifications
          </div>
          <div style={{ fontSize: 12, color: "var(--text1)", marginBottom: 18 }}>
              ...
              return (
                <div key={key} style={{
                  ...
                  <div style={{ flex: 1, marginRight: 14 }}>
                    ...
                    <div style={{ fontSize: 11, color: "var(--text1)" }}>{desc}</div>
                  </div>
                  <button
                    type="button"
                    onClick={toggle}
        ...
        {/* Change password */}
        <div className="card" style={{padding:24}}>
          <div style={{fontFamily:"var(--font-body)",fontSize:16,fontWeight:700,marginBottom:18}}>Change Password</div>
        ...
        <div className="card" style={{ padding: 28, gridColumn: "1/-1", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ fontFamily: "var(--font-body)", fontSize: 22, fontWeight: 800, marginBottom: 10 }}>
            GymPro CRM
          </div>

          <div style={{ fontSize: 14, color: "var(--text1)", marginBottom: 20, maxWidth: 600 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: 14 }}>
            {[
              ...
              <div key={label} style={{ background: "var(--surface2)", borderRadius: 10, padding: "14px 18px" }}>
                <div style={{ fontSize: 12, color: "var(--text1)", marginBottom: 6, fontWeight: 600 }}>
                  {label}
                </div>
        ...
        <div className="card" style={{ padding: 28, gridColumn: "1/-1" }}>
          ...
          <div style={{ marginBottom: 28 }}>
            <div style={{ fontFamily: "var(--font-body)", fontSize: 22, fontWeight: 800, marginBottom: 8 }}>
              Company Details
            </div>
            <div style={{ fontSize: 14, color: "var(--text1)", marginBottom: 18, maxWidth: 600 }}>
            </div>
          </div>
          ...
          <div>
            <div style={{ fontFamily: "var(--font-body)", fontSize: 16, fontWeight: 700, marginBottom: 16 }}>
              Appscore Solutions
            </div>
